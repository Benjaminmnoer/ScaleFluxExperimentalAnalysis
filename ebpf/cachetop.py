    ...
    while 1:
        ...
        if(count == last_count):
            with open(args.output, 'w', newline='') as f:
                ...
                f.write(f"Buffers MB: {buff} / Cached MB: {cached} / Sort: {FIELDS[sort_field]}\n")
                ...
                f.write("{0:8} {1:8} {2:16} {3:8} {4:8} {5:8} {6:10} {7:10}\n".format(*FIELDS))
                ...
                for i, stat in enumerate(process_stats):
                    ...
                    f.write("{0:8} {username:8.8} {2:16} {3:8} {4:8} "
                        "{5:8} {6:9.1f}% {7:9.1f}%\n".format(
                            *stat, username=username
                        ))
...
def parse_arguments():
    ...
    parser.add_argument(
        'interval', type=int, default=15, nargs='?',
        help='Interval between probes.'
    )
    parser.add_argument(
        '--pid', type=int, default=-1, 
        help='Process id to filter.'
    )
    parser.add_argument(
